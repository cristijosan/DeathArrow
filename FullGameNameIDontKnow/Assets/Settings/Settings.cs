...
public static class GameSettingsManager
{
    ...
    private static void SetResolution()
    {
        ...
        Enum.TryParse(PlayerPrefs.GetString(SaveKeys.Resolution, QualityType.Medium.ToString()),
    ...
    private static void ChangeResolution(QualityType qualityType)
    {
        ...
        switch (qualityType)
        {
            case QualityType.Low:
                ...
                break;
            case QualityType.Medium:
                newWidth = (int)(DefaultWidthScreen * 0.8f);
                newHeight = (int)(DefaultHeightScreen * 0.8f);
